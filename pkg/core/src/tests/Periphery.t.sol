...
contract PeripheryTest is TestHelper {
    ...
    function testCanReceiveETH() public {
        ...
        vm.expectRevert();
        periphery.swapForPTs{ value: 1e18 }(address(0), 0, 0, 0, address(0), permit, _getQuote(address(0), address(0)));
        ...
        vm.expectRevert();
        periphery.swapPTs{ value: 1e18 }(address(0), 0, 0, 0, address(0), permit, _getQuote(address(0), address(0)));

        vm.expectRevert();
        periphery.swapYTs{ value: 1e18 }(address(0), 0, 0, 0, address(0), permit, _getQuote(address(0), address(0)));
